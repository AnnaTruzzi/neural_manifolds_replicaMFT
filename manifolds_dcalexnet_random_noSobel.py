...
def main():
    model = models_dc.alexnet(sobel=False, bn=True, out=10000) 
    model.cuda()
    model = model.eval()
    sampled_classes = 100
    ...
    with open(('/home/annatruzzi/neural_manifolds_replicaMFT/features/manifolds_capacities_dcalexnet_random_noSobel.pickle'), 'wb') as handle:
        pickle.dump(capacities, handle)
    with open(('/home/annatruzzi/neural_manifolds_replicaMFT/features/manifolds_radii_dcalexnet_random_noSobel.pickle'), 'wb') as handle:
        pickle.dump(radii, handle)
    with open(('/home/annatruzzi/neural_manifolds_replicaMFT/features/manifolds_dimensions_dcalexnet_random_noSobel.pickle'), 'wb') as handle:
        pickle.dump(dimensions, handle)
    with open(('/home/annatruzzi/neural_manifolds_replicaMFT/features/manifolds_correlations_dcalexnet_random_noSobel.pickle'), 'wb') as handle:
    ...
    plt.tight_layout()
    plt.show()
    fig.savefig('/home/annatruzzi/neural_manifolds_replicaMFT/plots/manifolds_dcalexnet_random_noSobel.png',bbox_inches='tight')
